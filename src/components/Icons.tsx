...
export const LeetCodeIcon = ({ className = "w-5 h-5" }: IconProps) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
export const AcademicCapIcon = ({ className = "w-5 h-5" }: IconProps) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
...
export const CertificateIcon = ({ className = "w-5 h-5" }: IconProps) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
...
export const getSocialIcon = (icon: SocialLink['icon']) => {
  switch (icon) {
    case 'linkedin':
      return LinkedInIcon;
    case 'github':
